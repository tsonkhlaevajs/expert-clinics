 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".home-specialists__slider")) new core(".home-specialists__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".home-specialists__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".home-specialists__arrow-prev",
                    nextEl: ".home-specialists__arrow-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".actions-approach__slider")) new core(".actions-approach__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                slidesPerView: 1,
                pagination: {
                    el: ".actions-approach__pagination",
                    clickable: true
                }
            });
            if (document.querySelector(".slider-partners")) new core(".slider-partners", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                loop: true,
                navigation: {
                    prevEl: ".home-partners__arrow-prev",
                    nextEl: ".home-partners__arrow-next"
                },
                breakpoints: {
                    320: {
                        spaceBetween: 20,
            ...
            if (document.querySelector(".service-specialists__slider")) new core(".service-specialists__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                slidesPerView: 2.7,
                navigation: {
                    prevEl: ".service-specialists__arrow-prev",
                    nextEl: ".service-specialists__arrow-next"
                },
                pagination: {
                    el: ".service-specialists__pagination",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".home-documents__slider")) new core(".home-documents__slider", {
                modules: [ Pagination, Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                spaceBetween: 20,
                pagination: {
                    el: ".home-documents__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".home-documents__arrow-prev",
                    nextEl: ".home-documents__arrow-next"
                },
                breakpoints: {
                    320: {
                        spaceBetween: 20,
            ...
            if (document.querySelector(".specialist-reviews__slider")) new core(".specialist-reviews__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                slidesPerView: 2,
                navigation: {
                    prevEl: ".specialist-reviews__arrow-prev",
                    nextEl: ".specialist-reviews__arrow-next"
                },
                breakpoints: {
                    320: {
                        spaceBetween: 10,
...
***************************************************************************** */
        ...
        da.init();
        let servicesWrapper = document.querySelector(".servises__wrapper");
        document.querySelector(".servises__column");
        if (servicesWrapper) servicesWrapper.addEventListener("click", (function(event) {
            let target = event.target.closest(".show-btn");
            if (!target) return;
            target.parentNode.classList.toggle("open");
            if (target.parentNode.classList.contains("open")) target.innerHTML = `Свернуть`;
            if (!target.parentNode.classList.contains("open")) target.innerHTML = `Показать ещё`;
        }));
        let reviewsBody = document.querySelector(".reviews-body");
        document.querySelector(".controlls-reviews__buttons");
        document.querySelectorAll(".review-controlls-btn");
        if (reviewsBody) {
            function reviewsCo(event) {
                let evta = event.target;
                let reviewsText = document.querySelectorAll(".review-text");
                let reviewsVideo = document.querySelectorAll(".review-video");
                let reviewsAll = document.querySelectorAll(".review-all");
                if (evta.closest("#reviews-all")) for (var i = 0; i < reviewsText.length; i++) reviewsAll[i].classList.add("show"); else if (evta.closest("#reviews-video")) for (i = 0; i < reviewsText.length; i++) {
                    reviewsText[i].classList.remove("show");
                    reviewsVideo[i].classList.add("show");
                } else if (evta.closest("#reviews-text")) for (i = 0; i < reviewsText.length; i++) {
                    reviewsVideo[i].classList.remove("show");
                    reviewsText[i].classList.add("show");
                }
                evta.parentNode;
                let buttons = document.querySelectorAll(".review-controlls-btn");
                if (evta.closest(".review-controlls-btn")) {
                    for (i = 0; i < buttons.length; i++) buttons[i].classList.remove("_active");
                    evta.classList.add("_active");
                }
            }
            reviewsBody.addEventListener("click", reviewsCo);
        }
        let parrentReview = document.querySelector(".reviews-content");
        document.getElementsByTagName("video")[0];
        if (parrentReview) {
            let videoOpen = function(event) {
                let currentVideo = event.target.querySelector("video");
            ...
            parrentReview.addEventListener("click", videoOpen);
        }
        let pushModal = document.querySelector(".push-modal");
        function showModal() {
            pushModal.classList.add("active");
        }
        setTimeout(showModal, 5e3);
        function pushModalClose(event) {
            if (event.target.closest(".push-modal__close")) pushModal.remove();
        }
        pushModal.addEventListener("click", pushModalClose);
        window["FLS"] = true;
        isWebp();
        addTouchClass();
        menuInit();
